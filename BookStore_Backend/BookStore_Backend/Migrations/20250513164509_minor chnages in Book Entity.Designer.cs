...
namespace BookStore_Backend.Migrations
{
    ...
    [Migration("20250513164509_minor chnages in Book Entity")]
    partial class minorchnagesinBookEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore_Backend.Model.Cart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("01111111-5555-8888-9999-555555555555"),
                        ...
                        new
                        {
                            Id = new Guid("01111111-3333-2222-9999-555555555555"),
                            DiscountPercentage = 0.0,
                            DiscountedPrice = 0.0,
                            TotalPrice = 0.0
                        });
            ...
            modelBuilder.Entity("BookStore_Backend.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("01111111-2222-3333-4444-555555555555"),
                            CartId = new Guid("01111111-5555-8888-9999-555555555555"),
                            Email = "admin@gmail.com",
                            OrderCount = 0,
                            PasswordHash = "$2a$12$123456789012345678901uSzbb.45xjqbUhGhVY90FzYEX3zQOfWS",
                            ProfileImage = "",
                            Role = "Admin",
                            Username = "Admin"
                        },
                        new
                        {
                            Id = new Guid("02222222-2222-3555-4444-555555555555"),
                            CartId = new Guid("01111111-3333-2222-9999-555555555555"),
            ...
            modelBuilder.Entity("BookStore_Backend.Model.Book", b =>
                {
                    b.HasOne("BookStore_Backend.Model.Announcement", "Announcement")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("BookStore_Backend.Model.CartItem", b =>
                {
                    b.HasOne("BookStore_Backend.Model.Book", "Book")
                        .WithOne()
                        .HasForeignKey("BookStore_Backend.Model.CartItem", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStore_Backend.Model.Cart", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("BookStore_Backend.Model.Review", b =>
                {
                    ...
                    b.HasOne("BookStore_Backend.Model.Book", null)
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("BookStore_Backend.Model.WishList", b =>
                {
                    b.HasOne("BookStore_Backend.Model.Book", "Book")
                        .WithOne()
                        .HasForeignKey("BookStore_Backend.Model.WishList", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStore_Backend.Model.User", "User")
                        .WithMany("WishLists")
                        .HasForeignKey("Bookmark_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
